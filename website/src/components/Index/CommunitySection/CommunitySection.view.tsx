        ...
        <section>
            <div className={clsx("container padding-bottom--xl padding-top--lg text--center", styles.sectionDiv)}>
                ...
                <p className={clsx("padding-horiz--xl", styles.description)}>
                    The Unicorn History Server is an open-source project and we welcome contributions from the community. If you have any
                    questions, suggestions, or feedback, please feel free to reach out to us on GitHub.
                </p>
                <Link
                    className="button button--primary button--lg"
                    to="https://github.com/G-Research/unicorn-history-server/discussions/new/choose">

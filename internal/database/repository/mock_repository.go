...
//
//	mockgen -destination=internal/database/repository/mock_repository.go -package=repository github.com/G-Research/yunikorn-history-server/internal/database/repository Repository
//
